...
//乙方坦克
public class TankB extends Material{
	private static final long serialVersionUID = -4223371461827333366L;
	 ...
	 * @param speed 我方移动速度
	 */
	public TankB(int img_x, int img_y, int material_x, int material_y, int refurbish,int enemy, int speed) {
